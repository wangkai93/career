...
public class CmRecruit implements java.io.Serializable {
	private Integer rid;
	...
	public CmRecruit(CmArea cmAreaByAid, CmCompany cmCompanyByCid, Date rstart, Date rend, CmJob cmJobByJid,
			String rinfo, Integer rnum, Integer rsalary) {
	...
	public boolean equals(Object o) {
		...
		if (rid != null ? !rid.equals(cmRecruit.rid) : cmRecruit.rid != null)
			return false;
		if (rsex != null ? !rsex.equals(cmRecruit.rsex) : cmRecruit.rsex != null)
			return false;
		if (rsalary != null ? !rsalary.equals(cmRecruit.rsalary) : cmRecruit.rsalary != null)
			return false;
		if (rstart != null ? !rstart.equals(cmRecruit.rstart) : cmRecruit.rstart != null)
			return false;
		if (rend != null ? !rend.equals(cmRecruit.rend) : cmRecruit.rend != null)
			return false;
		if (rnum != null ? !rnum.equals(cmRecruit.rnum) : cmRecruit.rnum != null)
			return false;
		if (rinfo != null ? !rinfo.equals(cmRecruit.rinfo) : cmRecruit.rinfo != null)
			return false;
		if (rstate != null ? !rstate.equals(cmRecruit.rstate) : cmRecruit.rstate != null)
			return false;
