...
public class CmStudent implements java.io.Serializable {
	private Integer sid;
	private String sno;
	...
	public CmStudent(String sno, String sname, Boolean ssex, Date sbirth, String spro, Integer sgrade, Integer sclass,
			String sphone, String semail, String scode, String sdetail) {
		this.sno = sno;
		this.sname = sname;
		this.ssex = ssex;
		this.sbirth = sbirth;
	...
	public boolean equals(Object o) {
		...
		if (sid != null ? !sid.equals(cmStudent.sid) : cmStudent.sid != null)
			return false;
		if (sno != null ? !sno.equals(cmStudent.sno) : cmStudent.sno != null)
			return false;
		if (sname != null ? !sname.equals(cmStudent.sname) : cmStudent.sname != null)
			return false;
		if (ssex != null ? !ssex.equals(cmStudent.ssex) : cmStudent.ssex != null)
			return false;
		if (sbirth != null ? !sbirth.equals(cmStudent.sbirth) : cmStudent.sbirth != null)
			return false;
		if (spro != null ? !spro.equals(cmStudent.spro) : cmStudent.spro != null)
			return false;
		if (sgrade != null ? !sgrade.equals(cmStudent.sgrade) : cmStudent.sgrade != null)
			return false;
		if (sclass != null ? !sclass.equals(cmStudent.sclass) : cmStudent.sclass != null)
			return false;
		if (sphone != null ? !sphone.equals(cmStudent.sphone) : cmStudent.sphone != null)
			return false;
		if (semail != null ? !semail.equals(cmStudent.semail) : cmStudent.semail != null)
			return false;
		if (scode != null ? !scode.equals(cmStudent.scode) : cmStudent.scode != null)
			return false;
		if (smark != null ? !smark.equals(cmStudent.smark) : cmStudent.smark != null)
			return false;
		if (sassess != null ? !sassess.equals(cmStudent.sassess) : cmStudent.sassess != null)
			return false;
		if (sstate != null ? !sstate.equals(cmStudent.sstate) : cmStudent.sstate != null)
			return false;
		if (sdetail != null ? !sdetail.equals(cmStudent.sdetail) : cmStudent.sdetail != null)
			return false;
