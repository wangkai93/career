...
public class UserService {
    ...
    public List<CmUser> findAllUser(){
        String hsql="select  new cn.edu.zzia.career.pojo.CmUser(u.uid,u.urname) from CmUser u where u.uid!=0 ";
        List<CmUser>data=(List<CmUser>)hibernateTemplate.find(hsql);
        return  data;
    }
    //zxl：查询所有用户详细信息
    public List<CmUser>findAllUsers(){
        String hsql="select  new cn.edu.zzia.career.pojo.CmUser(u.uid,u.uname,u.urname, u.upwd, u.uemail, u.uphone,u.urank) from CmUser u where u.ustate=0 and u.uid!=0 ";
        List<CmUser>data=(List<CmUser>)hibernateTemplate.find(hsql);
        return  data;
    }
    //zxl：根据id和密码进行查询
    ...
    public CmUser findUser(String uname){
        String hsql="select new cn.edu.zzia.career.pojo.CmUser(u.uname,u.upwd) from CmUser u where u.uname=?";
    ...
    public CmUser findUserByEmp(int eid){
        String hsql="select  new cn.edu.zzia.career.pojo.CmUser(u.uid,u.uname,u.urname, u.upwd, u.uemail, u.uphone,u.urank) " +
