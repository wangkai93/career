...
public class EmpCtrl {
    ...
    public ModelAndView addEmp(String sid,String sno,String addsname,int addssex,String addsbirth,String addspro,String addsgrade,
        ...
        if (!sid.equals("")){
            ...
            cmArea1.setAid(city);
            CmCompany  cmCompany=new CmCompany(cname,chr,cphone,cemail,cinfo,cmark,caddress,cmArea1,new DateUtil().SysDate());
            //招聘表操作
            ...
            CmRecruit cmRecruit=new CmRecruit(cmArea2,cmCompany,new DateUtil().SysDate(),new DateUtil().SysDate(),cmJob,"",0,rsalary);
            //面试表操作
...
//            }
            ...
            CmInter cmInter=new CmInter(cmArea3,cmRecruit,cmStudent,iaddress,1,DateUtil.StringtoUtilDate(itime),itype);
            //就业是生表操作
            ...
            CmEmp cmEmp=new CmEmp(cmUser,cmJob,cmStudent,new DateUtil().StringtoDate(etime),einfo,rsalary,new DateUtil().SysDate(),flag);
            ...
            CmStudent cmStudent=new CmStudent(sno,addsname,flagsex,new DateUtil().StringtoDate(addsbirth),addspro,Integer.parseInt(addsgrade),Integer.parseInt(addsclass),addsphone,addsemail,addscode,addsdetail);
            //公司表操作
            CmArea cmArea1=new CmArea();
            cmArea1.setAid(city);
            CmCompany  cmCompany=new CmCompany(cname,chr,cphone,cemail,cinfo,cmark,caddress,cmArea1,new DateUtil().SysDate());
...
//        modelMap.put("pageCode",pageCode);
    ...
    public String inputEmp(@RequestParam(value = "file", required = false) MultipartFile file, HttpServletRequest request, ModelMap model){
        ...
        msg = empService.uploadEmp(path+File.separator+fileName);
