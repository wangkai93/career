...
<head>
    ...
    <script type="text/javascript">
        ...
        function delInter(iid,sid){
            ...
            if(result){
                window.location.href="${pageContext.request.contextPath}/inter/delInter3?iid="+iid+"&sid="+sid;
            }else{
                alert('不删除！');
            }
        }
...
<div class="table-box">
    <div class="table-content">
        ...
        <div class="button-footer">
            ...
            <div class="left-button-footer">
                <button class="mybutton" type="button" onclick="window.open('${pageContext.request.contextPath}/inter/outputInter')"> <span>导出数据</span></button>
            </div>
        </div>
    </div>
    ...
    <div id="showMeetResult">
        ...
        <div class="MeetResult">
            <p>修改面试结果：</p>
            <form action="${pageContext.request.contextPath}/inter/updateInter3" method="post">
                <table class="pure-table pure-table-bordered">
