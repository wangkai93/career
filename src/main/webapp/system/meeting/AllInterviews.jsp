...
<div class="table-box">
    <div class="table-content">
            ...
            <div class="table-address">
                ...
                <div class="Big-title">
                    ...
                    <div class="search-box">
                        <form action="${pageContext.request.contextPath}/inter/query2" method="post" name="search" id="search">
                ...
                <table  class="pure-table pure-table-bordered">
                    ...
                    <c:forEach var="inter" items="${interList}">
                        ...
                        <tr>
                            ...
                            <td>${inter.sno}</td>
                            <td><a href="${pageContext.request.contextPath}/company/findByCompCid?cid=${inter.cid}">${inter.cname}</a></td>
                            <td>${inter.jname}</td>
        ...
        <div>
            ...
            <div class="left-button-footer">
                <button type="submit" class="mybutton" value="Submit" onclick="window.open('${pageContext.request.contextPath}/inter/outputInter')">导出数据</button>
            </div>
        </div>
    </div>
    ...
    <div id="showMeetResult">
        ...
        <div class="MeetResult">
            <p>修改面试结果：</p>
            <form action="${pageContext.request.contextPath}/inter/updateInter2" method="post">
                <table class="pure-table pure-table-bordered">
