...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/bootstrap2.css"/>
    ...
    <script type="text/javascript">
        ...
        function queryRinfo(rid) {
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/recruit/queryRinfo?rid="+rid,
                dataType:"text",
        ...
        function delRecruit(rid){
            ...
            if(result){
                window.location.href="${pageContext.request.contextPath}/recruit/delRecruit?rid="+rid;
                alert("已删除！");
            }else{
                alert('不删除！');
            }
    ...
    <div class="table-content">
            ...
            <div class="table-address">
                ...
                <div class="Big-title">
                    ...
                    <div class="search-box">
                        <form action="${pageContext.request.contextPath}/recruit/query" method="post" name="search" id="search">
            ...
            <c:forEach var="recruit" items="${recruitList}">
                <table  class="pure-table pure-table-bordered left">
                    <tr>
                        ...
                        <td rowspan="3">
                            <button class="mybutton" type="button" onclick="location='${pageContext.request.contextPath}/recruit/findByRid?rid=${recruit.rid}'">编辑</button>
                        </td>
                    </tr>
                    <tr>
                        <td rowspan="4"><a href="${pageContext.request.contextPath}/recruit/findByCid?cid=${recruit.cid}">${recruit.cname}</a></td>
                    ...
                    <tr>
                        ...
                        <td>报名学生：</td>
                        <td>
                            <button class="mybutton" type="button" onclick="location='${pageContext.request.contextPath}/inter/findByRid?rid=${recruit.rid}'">详情</button>
                        </td>
                        <td rowspan="3">
        ...
        <div>
            ...
            <div class="left-button-footer">
                <button type="submit" class="mybutton" value="Submit" onclick="window.open('${pageContext.request.contextPath}/recruit/outputRecruit')">导出数据</button>
            </div>
        </div>
    </div>
