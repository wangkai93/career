            ...
            <c:if test="${list.jtype == true}">
                <div id="kaifastu">
                    ...
                    <table  class="pure-table pure-table-bordered left">
                        <tr>
                            <td rowspan="6" width="70px"><button class="mybutton" type="button" onclick="location='${pageContext.request.contextPath}/student/findBySid?sid=${list.sid}'">${list.sname}</button></td>
                            <td width="80px">班级：</td>
                            ...
                            <td rowspan="3">
                                <button class="mybutton" type="button" onclick="location='${pageContext.request.contextPath}/emp/forUpdateEmp?sid=${list.sid}'">编辑</button>
                            </td>
                        </tr>
                        <tr>
                            <td >就业企业：</td>
