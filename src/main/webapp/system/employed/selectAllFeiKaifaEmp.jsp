...
<div class="table-box">
    <div class="table-content">
        ...
        <div class="table-bar">
            <ul>
                <li onclick="location='${pageContext.request.contextPath}/emp/findAllEmp?page=1'"> 全部岗位 </li>
                <li onclick="ShowKaifaEmpStu()"> 开发岗 </li>
                <li class="active-li" onclick="ShowFeikaifaEmpStu()"> 非开发岗 </li>
            </ul>
        </div>
                    ...
                    <table  class="pure-table pure-table-bordered left">
                        <tr>
                            <td rowspan="6" width="70px">
                                <button class="mybutton" type="button" onclick="location='${pageContext.request.contextPath}/student/findBySid?sid=${emplist.sid}'">${emplist.sname}</button>
                            </td>
                            <td width="80px">班级：</td>
    ...
    <div>
        <div class="left-button-footer">
            <button type="submit" class="mybutton" value="Submit" onclick="window.open('${pageContext.request.contextPath}/emp/outputEmp')">导出数据</button>
        </div>
    </div>
</div>
