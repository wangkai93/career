...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/Date3.js" ></script>
    <script language="JavaScript">
        function snoajax(){
            var sno = document.getElementById("sno").value;
            // alert(sno);
            $.ajax({
                url:'${pageContext.request.contextPath}/unemp/selectStuBySno',
                type:'GET',
                data:{'key':sno},
...
<div class="table-box">
    <div class="table-content">
        ...
        <div id="allUnEmp-table">
            <form method="post" action="${pageContext.request.contextPath}/unemp/addUnEmp">
                <!--准备就业的表这是一条记录开始-->
