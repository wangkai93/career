...
<div class="table-box">
    <div class="table-content">
        ...
        <div class="table-bar">
            <ul>
                <li onclick="location='${pageContext.request.contextPath}/unemp/findAllUnemp?page=1'"> 全部动向 </li>
                    ...
                    <table  class="pure-table pure-table-bordered left">
                        <tr>
                            <td rowspan="4" width="70px">
                                <a href="${pageContext.request.contextPath}/student/findBySid?sid=${list.sid}">${list.sname}</a>
                            </td>
