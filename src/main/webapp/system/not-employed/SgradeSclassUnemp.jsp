        ...
        <div id="allUnemp">
            <c:forEach varStatus="i" var="list" items="${dataList}">
                ...
                <table  class="pure-table pure-table-bordered left">
                    <tr>
                        <td rowspan="5" width="70px"><a href="${pageContext.request.contextPath}/student/findBySid?sid=${list.sid}">${list.sname}</a></td>
            ...
            <c:forEach varStatus="i" var="list" items="${dataList}">
                <c:if test="${list.did == 1}">
                    ...
                    <table  class="pure-table pure-table-bordered left">
                        <tr>
                            <td rowspan="4">
                                <a href="${pageContext.request.contextPath}/student/findBySid?${list.sid}">${list.sname}</a>
                            </td>
                            <td width="100px">班级：</td>
                            <td width="100px">
                                <a onclick="ShowUnempStuBySclass(${list.sgrade},${list.sclass})">${list.spro}${list.sclass}班</a>
