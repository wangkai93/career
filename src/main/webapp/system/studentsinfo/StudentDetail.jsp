<%@ page import="cn.edu.zzia.career.pojo.CmStudent" %>
...
<script type="javascript">
    ...
    /*$(function(){
        var smark = ${student.smark};
        $("input[name=smark][value="+smark+"]").attr("checked","true");
    })*/
</script>
...
<div  class="printhide">
            <div class="button-footer">
                ...
                <div class="left-button-footer">
                    ...
                    &nbsp;&nbsp;
                    <button type="submit" class="mybutton" value="Submit" onclick="window.open('${pageContext.request.contextPath}/grade/outgrade?sid='+${student.sid})">导出数据</button>
                </div>
            </div>
</div>
        </div>
        <div id="qiwang-text">
            <c:if test="${isUnemp}">
                <form  id="form1" action="${pageContext.request.contextPath}/student/updateExpectation" method="post" >
                    ...
                    <table  class="pure-table pure-table-bordered left" id="table-qiwang">
                        ...
                        <c:if test="${student.did==2||student.did==5}">
                            ...
                            <tr>
                                <td>结果：</td>
                                <td>
                                    <select id="qw-jg" name="str3">
                                        <c:if test="${student.uesuccess==0}">
                                            <option value="0" selected="selected">暂无</option>
                                            <option value="1">成功</option>
                                            <option value="2">失败</option>
                                        </c:if>
                                        <c:if test="${student.uesuccess==1}">
                                            <option value="0">暂无</option>
                                            <option value="1" selected="selected">成功</option>
                                            <option value="2">失败</option>
                                        </c:if>
                                        <c:if test="${student.uesuccess==2}">
                                            <option value="0">暂无</option>
                                            <option value="1">成功</option>
            ...
            <c:if test="${!isUnemp}">
                ...
                <form method="post" action="${pageContext.request.contextPath}/unemp/addUnEmpBySid">
                    <!--这是一条记录开始-->
                    <input type="hidden" name="sid" value="${student.sid}">
                    <div id="mydiv1">
        ...
        <div id="mark-canvars">
            ...
            <form action="${pageContext.request.contextPath}/student/updateAbility" method="post">
