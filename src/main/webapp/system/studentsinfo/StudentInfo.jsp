...
<script type="text/javascript">
    ...
    function updateStudent(sid) {
        $.ajax({
            type: "GET",
            url: "${pageContext.request.contextPath}/student/updateStudentPro?sid="+sid,
            dataType:"text",
    ...
    function delStudent(sid){
        ...
        if(result){
            window.location.href="${pageContext.request.contextPath}/student/delStudent?sid="+sid;
            //alert(${ResMsg});
        }else{
            alert('不删除！');
        }
        ...
        <div>
            ...
            <table  class="pure-table pure-table-bordered" style="text-align: left;">
                ...
                <tr>
                    ...
                    <td>
                        <c:if test="${isemp}">
                            <a href="${pageContext.request.contextPath}/company/findByCompCid?cid=${student.cid}">
                                 ${student.cname}
                            </a>
                        </c:if>
                        <c:if test="${!isemp}">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ${InterTimes}次 &nbsp;
                        <button class="mybutton" type="button" onclick="location='${pageContext.request.contextPath}/student/findInterBySid?sid=${student.sid}'"  >查看详情</button>
                    </td>
                    <td>学生详细信息：</td>
                    <td colspan="2">
                        <button class="mybutton" type="button" onclick="location='${pageContext.request.contextPath}/grade/findStudentDetail?sid=${student.sid}'"  >查看详情</button>
                    </td>
                </tr>
            </table>
