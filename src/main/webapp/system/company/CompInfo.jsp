        ...
        <div class="table-content">
            ...
            <div>
                ...
                <table  class="pure-table pure-table-bordered CompInfo1" style="text-align: left;">
                    <tr>
                        ...
                        <td colspan="3">
                            <c:forEach var="job" items="${jobList}" varStatus="i">@${job.jname}&nbsp;&nbsp;</c:forEach>
                        </td>
                    </tr>
                    <tr>
            ...
            <div class="button-footer">
                ...
                <div class="left-button-footer">
                    <button class="mybutton" type="button" onclick="location='${pageContext.request.contextPath}/company/findCompByCid?cid=${lsit.cid}'">修改</button>
                </div>
            </div>
        </div>
    </c:forEach>
