            ...
            <div class="table-address">
                ...
                <div class="Big-title">
                    ...
                    <div class="search-box">
                        <form action="${pageContext.request.contextPath}/recruit/query" method="post">
                            <select name="type">
                ...
                <c:forEach var="recruit" items="${recruitList}">
                    <table  class="pure-table pure-table-bordered left">
                        ...
                        <tr>
                            ...
                            <td>报名学生：</td>
                            <td>
                                <button class="mybutton" type="button" onclick="location='${pageContext.request.contextPath}/inter/findByRid?rid=${recruit.rid}'">人</button>
                            </td>
                            <td rowspan="3">
