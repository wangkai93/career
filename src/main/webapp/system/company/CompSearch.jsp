            ...
            <div class="table-address">
                ...
                <div class="Big-title">
                    ...
                    <div class="search-box">
                        <from action="${pageContext.request.contextPath}/company/findbyname">
            ...
            <table  class="pure-table pure-table-bordered CompInfo1">
                ...
                <c:forEach varStatus="i" var="list" items="${listdata}" >
                    <tr>
                        ...
                        <td>${list.chr}</td>
                        <td>${list.cphone}</td>
                        <td><button class="mybutton" type="button" onclick="location='${pageContext.request.contextPath}/company/forCompStuInfo?cid=${list.cid}'">${stuCount}人</button></td>
