...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/Cityjs/AtaiJs-1.2.js" ></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/Cityjs/chengshi.js" ></script>
    ...
    <script language="javascript">
        function provinceajax(){
            ...
            $("#ddlCity").html("");
            $.ajax({
                url : '${pageContext.request.contextPath}/area/selectCity',
                type : 'GET',
                data :{'key':aprovince},
