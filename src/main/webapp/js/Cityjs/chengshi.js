var china = [
 ...
 function BindProvince(){
    ...
    var aprovince = document.getElementById("aprovince");
    aprovince.innerHTML = "";
    aprovince.options[0] = new Option(opt0,"");
    for(var i=0; i<ProvinceCount; i++){
        aprovince.options[i+1] = new Option(china[i][0],china[i][0]);
    }
 }
 ...
 function BindCity(City){
    ...
    for(var i=0; i<ProvinceCount; i++){
        ...
        aprovince.options[i+1] = new Option(china[i][0],china[i][0]);
        if(flag && chose){
            aprovince.options[i+1].selected = true;
            chose=false;
        }
    }
