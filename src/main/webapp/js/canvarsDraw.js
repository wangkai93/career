    var pieChart = {  
        ...
        render : function() {  
            ...
            this.circle.cy = this.height/2;  
             /*这是设置圆的半径的,盒子的宽高分别除以2.5*/
            this.circle.radius = Math.min(this.width/2.5, this.height/2.5) - Math.max(this.edge.width, this.edge.height);  
            var ctx = null;  
        ...
        showTooltips : function(loc, ctx) {  
            ...
            if(dis <= this.circle.radius) {  
                ...
                if(this.tooltips.tooltipCanvas == null) {  
                    ...
                    this.tooltips.tooltipCanvas.width = 90;  
                    this.tooltips.tooltipCanvas.height = 60;  
                }   
